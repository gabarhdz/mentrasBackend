...
class ToolsMetricsViewsTests(APITestCase):
    ...
    def test_product_get_refreshes_most_seen_metric_automatically(self):
        ...
        self.assertEqual(most_seen_product.views, 1)
    ...
    def test_metrics_view_returns_precomputed_metrics_for_pyme(self):
        ...
        self.client.get(reverse("product-detail", args=[self.product.id]))
        ...
        self.assertEqual(response.data["most_seen_products"][0]["views"], 1)
