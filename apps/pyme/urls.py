...
from .views import AccountPymes, CategoryList, MemberPymes, MyPymes, PymeDetail, PymeEmployeeDetail, PymeEmployees


urlpatterns = [
    path("", AccountPymes.as_view(), name="account-pymes"),
    path("my/", MyPymes.as_view(), name="my-pymes"),
    path("member/", MemberPymes.as_view(), name="member-pymes"),
